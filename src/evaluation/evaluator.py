...
from src.config.settings import AlgorithmType, EnvironmentConfig
    ...
    def _print_results(
        ...
        if vec_normalize_loaded:
            if result.mean_reward > 5000:
                print("    🎉 EXCELLENT! The robot walks very well!")
            elif result.mean_reward > 2000:
                print("    ✅ GOOD! The robot has learned to walk!")
            elif result.mean_reward > 500:
                print("    🆗 OKAY! The robot is starting to walk!")
            elif result.mean_reward > 100:
                print("    ⚠️  POOR! The robot is struggling!")
            else:
                print("    ❌ BAD! The robot hasn't learned much!")
        else:
            print("    ⚠️  Hard to evaluate without normalization stats!")
